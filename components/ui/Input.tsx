  ...
  ({ label, error, helperText, className = '', ...props }, ref) => {
    return (
      <div className="w-full">
        ...
        <input
          ref={ref}
          className={`w-full h-[var(--input-height)] px-4 py-2 bg-[var(--panel-2)] border border-[var(--border)] text-[var(--text)] placeholder-[var(--text-muted)] rounded-[var(--radius-control)] transition-colors focus:outline-none focus:border-[var(--border-active)] focus:ring-2 focus:ring-[var(--ring)] disabled:bg-[var(--panel)] disabled:text-[var(--text-disabled)] disabled:cursor-not-allowed ${error ? 'border-[var(--danger)]' : ''} ${className}`}
          {...props}
        />
  ...
  ({ label, error, helperText, options, className = '', ...props }, ref) => {
    return (
      <div className="w-full">
        ...
        <select
          ref={ref}
          className={`w-full h-[var(--input-height)] px-4 py-2 bg-[var(--panel-2)] border border-[var(--border)] text-[var(--text)] rounded-[var(--radius-control)] transition-colors focus:outline-none focus:border-[var(--border-active)] focus:ring-2 focus:ring-[var(--ring)] disabled:bg-[var(--panel)] disabled:text-[var(--text-disabled)] disabled:cursor-not-allowed appearance-none cursor-pointer ${error ? 'border-[var(--danger)]' : ''} ${className}`}
          style={{
